...
1. **Headings**: Use appropriate heading levels (H1, H2, etc.) to structure your content.
...
<-- Adapted from: https://github.com/github/awesome-copilot/blob/main/instructions/markdown.instructions.md -->
